...
#command = 'parse_log.sh ' + model_log_path
...
train_loss, = ax1.plot(train_log['NumIters'], train_log['TrainingLoss'], color='red',  alpha=.5)
test_loss, = ax1.plot(test_log['NumIters'], test_log['TestLoss'], linewidth=2, color='green')
...
ax2 = ax1.twinx()
test_accuracy, = ax2.plot(test_log['NumIters'], test_log['TestAccuracy'], linewidth=2, color='blue')
